...
_reactDom2.default.render(_react2.default.createElement(_todoApp.TodoApp, null), document.getElementById('todo-app'));
...
var TodoApp = exports.TodoApp = function (_Component) {
  ...
  function TodoApp(props) {
    ...
    _this.toggleDoneFlag = _this.toggleDoneFlag.bind(_this);
    _this.removeItem = _this.removeItem.bind(_this);
    _this.state = { todoList: [] };
    return _this;
  }
  ...
  _createClass(TodoApp, [{
    ...
    value: function addTodo(text) {
      var prevState = this.state.todoList;
      this.setState({ todoList: [].concat(_toConsumableArray(prevState), [{ text: text, done: false }]) });
    }
  }, {
    key: 'toggleDoneFlag',
    value: function toggleDoneFlag(index) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_inputField.InputField, { addTodo: this.addTodo }),
...
var _todoItem = __webpack_require__(30);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TodoList = exports.TodoList = function TodoList(_ref) {
  var list = _ref.list,
      toggleDoneFlag = _ref.toggleDoneFlag,
      removeItem = _ref.removeItem;


  var todoItems = list.map(function (_ref2, index) {
    var text = _ref2.text,
        done = _ref2.done;
